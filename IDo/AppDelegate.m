...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //
    //判断本地标志 若为第一次安装 显示引导页
//    [Storage setGuidanceValue:NO];
    
    if ([Storage getGuidanceValue]) {
...
//    [self setupHomeView]; //原有写的调控制器的代码位置
...
- (GuidanceViewController *)createGuidanceView{
    ...
    NSArray *imageArray = @[@"引导页01.png",@"引导页02.png",@"引导页03.png"];
