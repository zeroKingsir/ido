...
//    UILabel *contentLab=[[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(nameLab.frame)+20*HEIGHT/960, WIDTH, 60)];//原来
...
//    contentLab.font=[UIFont systemFontOfSize:15];//原来
...
//    infoLab.font=[UIFont systemFontOfSize:25*HEIGHT/960];//原来
